...
public class Product_OrderVO {
		...
		public String toString() {
			return "Product_OrderVO [code=" + code + ", member_id=" + member_id + ", product_code=" + product_code
					...
					+ delivery_code + ", cancle_code=" + cancle_code + ", delivery_address=" + delivery_address
					+ ", phone=" + phone + ", name=" + name + ", message=" + message + ", use_point=" + use_point
					+ ", left_point=" + left_point + ", card=" + card + ", account=" + account + ", bankbook="
					+ bankbook + ", montant=" + montant + "]";
		}
}