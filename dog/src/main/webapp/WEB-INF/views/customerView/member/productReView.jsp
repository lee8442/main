...
<body>
<center>
   <form id="boardForm"method="post" action="" name="boardForm" enctype="multipart/form-data" onsubmit="return formCheck();">
    <input type="hidden" name="board_id" value="${sessionScope.sessionID}">
    <br>
    <b><font size="6" color="black">상품평(상품후기)글쓰기</font></b>
    <br>
    <table class="this" width="700" border="3" bordercolor="lightgray" align="center">
        <tr class="this">
            <td id="title" class="thistd">작성자</td>
            <td class="thistd">${sessionScope.sessionID}</td>
        </tr>
            <tr class="this">
            <td id="title" class="thistd">
               	 제 목
            </td>
            <td class="thistd">
                <input name="board_subject" type="text" size="70" maxlength="100" value="" placeholder="제목을 입력해주세요.">
            </td>        
        </tr>
        <tr class="this">
        ...
        <tr class="this">
            ...
            <td class="thistd">
                <textarea name="board_content" cols="72" rows="20" placeholder="내용을 입력해주세요."></textarea>            
            </td>        
        </tr>
        <tr class="this">
            <td id="title" class="thistd">
