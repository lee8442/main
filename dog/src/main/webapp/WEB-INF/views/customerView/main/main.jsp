			...
			<div class="hot cf">
				...
				<div class="imageLogin_full">
					<div class="imageLogin">
						<h3>신상품 사진</h3>
						<img class="newImage" src=resources/image/main/img1.png width="100%" height="230px;">
					</div>
					<div class="imageLogin">
						<h3>신상품 사진</h3>
						<img class="newImage" src="resources/image/main/img3.png" width="100%" height="230px;">
					</div>
					<div class="imageLogin">
						<h3>신상품 사진</h3>
						<img class="newImage" src="resources/image/main/img2.png" width="100%" height="230px;">
					</div>
				...
				<div class="boardImage">
					<div class="boardImage_top">
						<form action="#" method="post">
							...
							<div class="loginFind">
								<a class="loginFind-id" href="detailspage.do">아이디 찾기 / 비밀번호 찾기 </a>
								
								<a class="loginFind-signUp" href="insertMemberForm.do"> | 회원가입</a>
							</div>
					</div>
					<div class="boardImage_bottom">
						<input class="loginBtn" type="image"  src=" resources/image/main/naver.png" onfocus="this.blur()">
						<input class="loginBtn2" type="image"  src=" resources/image/main/kakao.JPG" onfocus="this.blur()">
					</div>
				</div>
			</div>
			<div class="box">
				<h4>추천 상품</h4>
				<ul class="cf">
					<li><a href="detailspage.do"></a><img src="resources/member/image/image03.jpg"></li>
