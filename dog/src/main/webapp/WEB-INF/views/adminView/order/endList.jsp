...
<body>
	...
	<form id="list">
		<table border="1">
			...
			<tr>
				<td>
					<input type="button" onclick="endExchangeStart()" value="교환신청">
				</td>
				<td>
					<input type="button" onclick="endRefundStart()" value="환불신청">
				</td>
				<td>
					<input type="button" onclick="OrderDeliveryStert()" value="배송중">
				</td>
			</tr>
		</table>
